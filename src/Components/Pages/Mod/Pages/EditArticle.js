      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-[72px] w-[100%] items-start">
        <div className="lg:w-[40vw] flex flex-col gap-8 items-center">
          ...
          <div className="flex lg:hidden justify-end items-end w-[100%] gap-8">
            ...
            <button
              className="bg-Rose100 text-white flex gap-2 lg:gap-6 items-center py-2 px-7 md:py-3 md:px-10 lg:py-6 lg:px-16  rounded-[8px] font-semibold text-[.9rem] md:text-[1.2rem]"
          ...
          <div className="flex flex-col gap-4 w-[100%]">
            <h3 className="text-[1.1rem] md:text-[1.3rem] lg:text-[1.7rem] text-Typo font-extrabold">Abstract</h3>
            ...
            <div className="flex flex-col gap-4 w-[100%]">
              ...
              <div className="flex gap-4 flex-wrap">
                {!modify ? <textarea
                  ...
                  onChange={handleChange}
                  name="references"
                  className="text-wrap bg-[#FEF5F7] px-8 py-4 md:px-8 md:py-4 flex items-center justify-center rounded-[4px] w-[100%] h-[200px]"
                  readOnly
                /> : 
                <textarea
                  value={refre}
