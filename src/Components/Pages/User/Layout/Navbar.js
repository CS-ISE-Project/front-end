      ...
      <nav className="w-full md:h-[112px] h-[88px] bg-white fixed top-0 z-[100]">
        <div className="flex items-center px-[8vw] h-full justify-between">
          ...
          <div className="flex gap-[16px] items-center ">
            <div>
              <p className="font-Gilroy bg-Purple100 py-2 px-4 text-white rounded">
                Utilisateur
              </p>
            </div>
            <p className="font-Gilroy font-bold text-Purple100">{userName}</p>
            <FaChevronDown className="text-Purple100" />
          </div>
        </div>
      </nav>
    </>
